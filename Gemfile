...
gem 'bootstrap-sass', '~> 3.3', '>= 3.3.7' # wyglad strony
gem 'font-awesome-rails', '~> 4.7', '>= 4.7.0.2' # wyglad strony
gem 'will_paginate-bootstrap', '~> 1.0', '>= 1.0.1' # wyglad strony - paginacja
